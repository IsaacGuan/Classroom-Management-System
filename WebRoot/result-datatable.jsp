...
<body class="page-body">
	 ...
	 <%
  	...
  	%>
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">申请结果</h1>
					<p class="description">用户申请使用教室的结果</p>
				</div>
			</div>
        				...
        				%> 
							<tr>
								...
								<td>
									...
									if(Integer.parseInt(rs.getString(9))==0){
									%>
										<a href="javascript:void(0)" onclick="cancel(this);">取消申请</a>
									<%
									}
									if(Integer.parseInt(rs.getString(9))==1){
									    out.print("申请成功");
	...
	function cancel(obj){
		...
		$('#applyname').val(tds.eq(0).text().trim());
		$('#classroom').val(tds.eq(1).text().trim());
		$('#weekday').val(tds.eq(3).text().trim());
		$('#period').val(tds.eq(2).text().trim());
		$('#week').val(tds.eq(4).text().trim());
		$('#activity').val(tds.eq(5).text().trim());
		$('#cancel').modal('show');		
	}
	</script>
	...
	<div class="modal fade" id="cancel">
		<div class="modal-dialog">
			<div class="modal-content">
			<form id="form2" name="form2" action="cancel.jsp" autocomplete="on" method="post">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="applyuserid" name="applyuserid" value="<%= userid%>" readonly>
							</div>	
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
					<input type="submit" class="btn btn-info" value="取消申请">
				</div>
				</form>
			</div>
		</div>
