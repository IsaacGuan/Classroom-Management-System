	...
	<div class="page-container">
	 ...
	 ResultSet rs=null;
	 	 try{
		 	...
		 	String sql = "select * from classroom where weekday = " + weekday + " and startweek < " + currentweek + " and endweek > " + currentweek + " and isempty = 0";
		 	rs= DB.executeQuery(stmt, sql);
  	%>
			<div class="page-title">
				
				<div class="title-env">
					<h1 class="title">今日课程</h1>
					<p class="description">现在是第<%= Integer.toString(currentweek)%>周 今天是周<%= Integer.toString(weekday)%></p>
				</div>
			</div>
        				...
        				%> 
							<tr>
								...
								<td><%
									...
									out.print(rs.getString(9)+"节");
								%>
								</td>
								<td><%
									out.print(rs.getString(6)+"-");
									out.print(rs.getString(7)+"周");
								%>
								</td>
								<td>
									<%
