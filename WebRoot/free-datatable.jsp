	...
	<div class="page-container">
	 ...
	 ResultSet rs=null;
	 	 try{
		 	...
		 	String sql = "select * from classroom where weekday = " + weekday + " and startweek <= " + currentweek + " and endweek >= " + currentweek + " and isempty = 1;";
		 	rs= DB.executeQuery(stmt, sql);
  	%>
			<div class="page-title">
				
				<div class="title-env">
					<h1 class="title">我要自习</h1>
					<p class="description">今日的空闲教室</p>
				</div>
			</div>
