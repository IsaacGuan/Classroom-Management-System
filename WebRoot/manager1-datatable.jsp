...
<body class="page-body">
	...
	<%
  	...
  	%>
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">教室申请</h1>
					<p class="description">所有教室申请信息</p>
				</div>
			</div>
        				...
        				%> 
							<tr>
								...
								<td>
									...
									if(Integer.parseInt(rs.getString(9))==2){
									    out.print("已过期");
									}
									%>								
								</td>
								...
								<td>
								    ...
								    if(Integer.parseInt(rs.getString(9))==0){
								    %>
									<a href="javascript:void(0)" onclick="confirm(this);">同意</a>
									<%
									}
									if(Integer.parseInt(rs.getString(9))==1){
									    out.print("已同意");
	...
	function confirm(obj){
		...
		$('#applyuserid').val(tds.eq(0).text().trim());
		$('#applyname').val(tds.eq(1).text().trim());
		$('#classroom').val(tds.eq(2).text().trim());
		$('#weekday').val(tds.eq(4).text().trim());
		$('#period').val(tds.eq(3).text().trim());
		$('#week').val(tds.eq(5).text().trim());
		$('#activity').val(tds.eq(6).text().trim());
		$('#confirm').modal('show');		
	}
	...
	<div class="modal fade" id="confirm">
		<div class="modal-dialog">
			<div class="modal-content">
			<form id="form2" name="form2" action="approve.jsp" autocomplete="on" method="post">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label for="applyuserid" class="control-label">申请人学号</label>

								<input type="text" class="form-control" id="applyuserid" name="applyuserid" readonly>
							</div>	
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="applyname" name="applyname" readonly>
							</div>	
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label for="classroom" class="control-label">申请教室</label>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<input class="form-control" id="activity" name="activity" required="required" readonly>
							</div>	
				...
				<div class="modal-footer">
					...
					<input type="submit" class="btn btn-info" value="确认同意">
				</div>
				</form>
			</div>
		</div>
